...
def Ad1(event):
    global Checkpoint,Checkpoint_mus, ChambreHaroldOuverte, Loaded
    Checkpoint = "Ad1"
    Checkpoint_mus = BGM_Maison
    if Loaded == True:
        Loaded = False
